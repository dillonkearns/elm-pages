...
${configName} routeParams =
  ...
  return `module TestApp exposing (start, ProgramTest, ${exposing})
...
The per-route configs (e.g. \`TestApp.index\`) are available for the older
\`PagesProgram.start\` API which drives a simplified state machine.
