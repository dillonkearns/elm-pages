...
type TemporaryResponse errorPage
    = New Effect
    | Old (PageServerResponse { head : List Tag, view : String, title : String } errorPage)
                                                    ...
                                                    (\something ->
                                                        ...
                                                        DataSource.map3
                                                            (\pageData sharedData tags ->
                                                                let
                                                                    renderedResult : TemporaryResponse errorPage
                                                                    renderedResult =
                                                                        case pageData of
